...
enum PersistenceStoreTopology {
    static let cloudStoreName = "PomoGem"
    static let localProjectionStoreName = "PomoGemLocalProjection"
    static let localOnlySourceStoreName = "PomoGemLocalOnly"
    static let localOnlyProjectionStoreName = "PomoGemLocalOnlyProjection"
    static let simulatorCloudStoreName = "PomoGemSimulator"
    static let simulatorLocalProjectionStoreName = "PomoGemSimulatorLocalProjection"
    ...
    private static func parseMigrationArtifactName(
        ...
        let prefix = ".pomogem-local-projection-"
...
private struct LocalProjectionStoreMigration {
    ...
    static func sidecarURL(localStoreURL: URL, identifier: String) -> URL {
        localStoreURL.deletingLastPathComponent()
            .appendingPathComponent(".pomogem-local-projection-\(identifier).json")
    }

    static func stagingURL(localStoreURL: URL, identifier: String) -> URL {
        localStoreURL.deletingLastPathComponent()
            .appendingPathComponent(".pomogem-local-projection-\(identifier).staging.json")
    }
