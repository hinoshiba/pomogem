        ...
        GeometryReader { proxy in
            ...
            ZStack {
                DropJarBody()
                    .stroke(
                        LinearGradient(
                            colors: [PomoGemTheme.auroraWarm, PomoGemTheme.auroraBlue],
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                        ),
                        style: StrokeStyle(
                ...
                RoundedRectangle(cornerRadius: size.width * 0.055, style: .continuous)
                    .fill(
                        RadialGradient(
                            colors: [.white, PomoGemTheme.auroraWarm, Color("subj.eng")],
                            center: .topLeading,
                            startRadius: 0,
                    ...
                    .shadow(color: PomoGemTheme.auroraWarm.opacity(0.55), radius: 3)
