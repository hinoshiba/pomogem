...
enum FortyYearPersistentUITestFixture {
    static let storeEnvironmentKey = "TSUMIBEN_UI_TEST_PERSISTENT_STORE"
    static let actionEnvironmentKey = "TSUMIBEN_UI_TEST_PERSISTENT_ACTION"
    static let overviewEnvironmentKey = "TSUMIBEN_UI_TEST_FORTY_YEAR_OVERVIEW"
    ...
    static func request(environment: [String: String]) -> Request? {
        ...
        let directory = support
            .appendingPathComponent("TsumibenPersistentUITestStores", isDirectory: true)
            .appendingPathComponent(name, isDirectory: true)
        return Request(
            name: name,
            action: action,
            storeURL: directory.appendingPathComponent("Tsumiben.store")
        )
    }
    ...
    private static func safelyRemoveStoreDirectory(_ directory: URL) throws {
        ...
        guard target.deletingLastPathComponent() == base,
              base.lastPathComponent == "TsumibenPersistentUITestStores"
