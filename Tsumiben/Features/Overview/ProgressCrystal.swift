                    ...
                    .fill(
                        RadialGradient(
                            colors: [
                                ...
                                TsumibenTheme.auroraViolet.opacity(reduceTransparency ? 0.03 : 0.13),
                                .clear
                            ],
                            center: .center,
                            startRadius: 0,
                    ...
                    .stroke(
                        LinearGradient(
                            colors: [
                                ...
                                .white.opacity(0.90),
                                TsumibenTheme.auroraViolet.opacity(0.70)
                            ],
                    ...
                    .stroke(
                        LinearGradient(
                            colors: [
                                ...
                                TsumibenTheme.auroraViolet.opacity(outlineOpacity * 0.72)
                            ],
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                        ),
                        ...
                        ? AnyShapeStyle(
                            AngularGradient(
                                colors: [
                                    Color(hex: colorHex),
                                    .white,
                                    TsumibenTheme.auroraBlue,
                                    TsumibenTheme.auroraViolet,
                                    Color(hex: colorHex)
                                ],
                                center: .center
                            )
                        )
                        : AnyShapeStyle(TsumibenTheme.raised.opacity(highContrast ? 0.96 : 0.78))
                )
                .overlay {
                    DiamondSlot()
                        .stroke(
                    ...
                    .fill(
                        RadialGradient(
                            colors: [
                                ...
                                TsumibenTheme.auroraViolet.opacity(reduceTransparency ? 0.04 : 0.11),
                                .clear
                            ],
                            center: .center,
                            startRadius: 3,
        ...
        return ZStack {
            JarAccumulationLightFieldShape()
                .fill(
                    LinearGradient(
                        colors: [
                            TsumibenTheme.auroraViolet.opacity(
                                reduceTransparency ? 0.06 : 0.025
                            ),
                            Color(hex: colorHex).opacity(
                                reduceTransparency ? 0.14 : 0.075
                            ),
                            TsumibenTheme.auroraBlue.opacity(
    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            ZStack {
                    ...
                    .fill(
                        RadialGradient(
                            colors: [
                                ...
                                TsumibenTheme.auroraViolet.opacity(reduceTransparency ? 0.04 : 0.13),
                                .clear
                            ],
                            center: .center,
                            startRadius: 3,
                ...
                .padding(.horizontal, 9)
                .padding(.vertical, 5)
                .background(TsumibenTheme.raised.opacity(0.72), in: RoundedRectangle(cornerRadius: 10, style: .continuous))
                .overlay {
                    RoundedRectangle(cornerRadius: 10, style: .continuous)
