        ...
        .background(
            LinearGradient(
                colors: [
                    ...
                    TsumibenTheme.raised.opacity(0.84)
                ],
...
private struct FusionHierarchyMetric: View {
    ...
    var body: some View {
        ...
        .padding(.vertical, 8)
        .frame(maxWidth: .infinity, alignment: .leading)
        .background(TsumibenTheme.card.opacity(0.76), in: RoundedRectangle(cornerRadius: 11))
    }
}
...
private struct MonthBottleCard: View {
    ...
    var body: some View {
        ...
        .padding(13)
        .background(TsumibenTheme.card, in: RoundedRectangle(cornerRadius: 19))
        .accessibilityElement(children: .combine)
        .accessibilityLabel(
...
private struct MiniBottleGraphic: View {
    ...
    var body: some View {
        Canvas { context, size in
            ...
            context.fill(bottle, with: .color(TsumibenTheme.raised.opacity(0.36)))
            context.stroke(bottle, with: .color(TsumibenTheme.glassEdge.opacity(0.42)), lineWidth: 1.5)
...
private struct OverviewBottleGraphic: View {
    ...
    var body: some View {
        Canvas { context, size in
            ...
            context.fill(bottle, with: .color(TsumibenTheme.raised.opacity(0.28)))
            context.stroke(bottle, with: .color(TsumibenTheme.glassEdge.opacity(0.48)), lineWidth: 2)
            ...
            for (index, cluster) in clusters.enumerated() {
                ...
                context.fill(outer, with: .color(TsumibenTheme.card))
                context.stroke(outer, with: .color(TsumibenTheme.amber.opacity(0.75)), lineWidth: 1.5)
            ...
            for (index, milestone) in milestones.enumerated() {
                ...
                context.stroke(stone, with: .color(TsumibenTheme.amber), lineWidth: 2)
                context.draw(
                    Text(milestone.mark)
