...
- Siri・Spotlight・ショートカット・アクションボタンの「集中を始める」（ホームの開始ボタンと同じ条件）
...
設定から勉強アプリと控えたいアプリを別々に選び、10分単位で記録します。黒い石は瓶の障害物として
黒同士だけでまとまり、勉強時間や共有画像には含めません。アプリの選択と黒い石は端末内だけに保存します。
